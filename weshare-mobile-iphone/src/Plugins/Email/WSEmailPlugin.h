...
@class WSSharePluginDialog, MFMailComposeViewController;

@interface WSEmailPlugin : WSBasePlugin <MFMailComposeViewControllerDelegate, WSSharePluginDialogDelegate> {
