/*
 ...
 Created by Reiner Pittinger <reiner.pittinger@neofonie.de> on 08.01.10.
...
@interface WSSharingResultView : UIView {
	
	IBOutlet UIImageView* iconView;
	IBOutlet UILabel* titleLabel;
	IBOutlet UITextView* errorMessageView;

}

@property (nonatomic, assign) IBOutlet UIImageView* iconView;
@property (nonatomic, assign) IBOutlet UILabel* titleLabel;
@property (nonatomic, assign) IBOutlet UITextView* errorMessageView;
