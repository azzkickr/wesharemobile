...
@class WeShareDemoViewController;

@interface WeShareDemoAppDelegate : NSObject <UIApplicationDelegate> {
    UIWindow *window;
    WeShareDemoViewController *viewController;
}

@property (nonatomic, retain) IBOutlet UIWindow *window;
@property (nonatomic, retain) IBOutlet WeShareDemoViewController *viewController;
